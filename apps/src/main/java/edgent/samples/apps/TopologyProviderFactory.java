...
public class TopologyProviderFactory {
     ...
     * <p>
     * The default provider is {@code edgent.providers.direct.DirectProvider}.
     * <p>
    ...
    public DirectProvider newProvider() throws Exception {
        String name = props.getProperty("topology.provider", "edgent.providers.direct.DirectProvider");
        Class<?> clazz = null;
        try {
