 ...
 * <p>
 * {@link edgent.connectors.kafka.KafkaProducer KafkaProducer} is
 * a connector used to create a bridge between topology streams
 * and publishing to Kafka topics.
 * <p>
 * {@link edgent.connectors.kafka.KafkaConsumer KafkaConsumer} is
 * a connector used to create a bridge between topology streams
 ...
 * <UL>
 * <LI>
 * {@code java -cp samples/lib/edgent.samples.connectors.kafka.jar
 *  edgent.samples.connectors.kafka.KafkaClient -h
