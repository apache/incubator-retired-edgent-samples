...
under the License.
*/
package edgent.samples.connectors.kafka;

import static edgent.samples.connectors.kafka.KafkaClient.OPT_BOOTSTRAP_SERVERS;
import static edgent.samples.connectors.kafka.KafkaClient.OPT_PUB;
import static edgent.samples.connectors.kafka.KafkaClient.OPT_TOPIC;
import static edgent.samples.connectors.kafka.KafkaClient.OPT_ZOOKEEPER_CONNECT;
