...
under the License.
*/
package edgent.samples.connectors.mqtt;

import static edgent.samples.connectors.mqtt.MqttClient.OPT_ACTION_TIMEOUT_MILLIS;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_CLEAN_SESSION;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_CLIENT_ID;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_CN_TIMEOUT_SEC;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_IDLE_RECONNECT_INTERVAL_SEC;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_IDLE_TIMEOUT_SEC;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_KEY_STORE;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_KEY_STORE_PASSWORD;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_PASSWORD;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_PUB;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_SERVER_URI;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_TOPIC;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_TRUST_STORE;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_TRUST_STORE_PASSWORD;
import static edgent.samples.connectors.mqtt.MqttClient.OPT_USER_ID;

import edgent.connectors.mqtt.MqttConfig;
import edgent.console.server.HttpServer;
import edgent.providers.development.DevelopmentProvider;
import edgent.samples.connectors.Options;
