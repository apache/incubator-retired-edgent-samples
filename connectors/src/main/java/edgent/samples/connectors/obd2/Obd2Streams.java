...
under the License.
*/
package edgent.samples.connectors.obd2;

import static edgent.analytics.math3.stat.Regression.SLOPE;
import static edgent.analytics.math3.stat.Statistic.MAX;
import static edgent.samples.connectors.elm327.Cmd.PID;
import static edgent.samples.connectors.elm327.Cmd.VALUE;
import static edgent.samples.connectors.elm327.Pids01.AIR_INTAKE_TEMP;
import static edgent.samples.connectors.elm327.Pids01.ENGINE_COOLANT_TEMP;
import static edgent.samples.connectors.elm327.Pids01.RPM;
import static edgent.samples.connectors.elm327.Pids01.SPEED;
...
import edgent.samples.connectors.elm327.Elm327Streams;
...
public class Obd2Streams {
     ...
     * {@link edgent.samples.connectors.elm327.Cmd#PID pid}. Filter so that only
     ...
     * {@link edgent.samples.connectors.elm327.Pids01#AIR_INTAKE_TEMP AIR_INTAKE_TEMP} and
     * {@link edgent.samples.connectors.elm327.Pids01#ENGINE_COOLANT_TEMP ENGINE_COOLANT_TEMP}.
     * 
     ...
     * and engine revs (rpm).
     * 
     * {@link edgent.samples.connectors.elm327.Pids01#SPEED Speed}
     * and {@link edgent.samples.connectors.elm327.Pids01#RPM engine revs}
