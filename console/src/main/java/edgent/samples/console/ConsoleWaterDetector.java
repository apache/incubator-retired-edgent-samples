...
under the License.
*/
package edgent.samples.console;
 ...
 * about how metrics are added to a topology, see the details in the edgent.metrics.Metrics class and the counter method.
 * <br>
 * A counter can be added to an individual oplet, and not the entire topology.  For an example of this
 * see the edgent.samples.utils.metrics.DevelopmentMetricsSample.
 * </P>
 * <P>
 * The edgent.metric.Metrics class also provides a rate meter.  Rate meters must be added to individual oplets and are not currently
