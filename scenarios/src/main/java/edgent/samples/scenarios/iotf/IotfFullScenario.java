...
under the License.
*/
package edgent.samples.scenarios.iotf;


import java.io.File;

import edgent.connectors.iotf.IotfDevice;
import edgent.providers.iot.IotProvider;
import edgent.samples.connectors.iotf.IotfSensors;
 ...
 * {@link edgent.providers.direct.DirectProvider}.
 * 
 * </P>
 * 
 * @see edgent.topology.mbeans.ApplicationServiceMXBean
 * @see edgent.topology.mbeans
 */
