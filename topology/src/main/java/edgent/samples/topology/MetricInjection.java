...
public class MetricInjection {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Topology top = dp.newTopology("MetricInjection");
...
//        
        ...
        TStream<Double> readings = top.poll(sensor, 1000, TimeUnit.MILLISECONDS)
                                      .tag("readings");
//        
...
//            .tag("results");
            readings
              ...
              .filter(Functions.alwaysTrue())
                // does CM+SS get injected? NO
              .peek(t -> {})
                // does CM+SS get injected? NO
              .peek(t -> {})
                // does CM+SS get injected? YES (NO if CounterOp follows)
              .peek(new CounterOp<>())
                // does CM+SS get injected? YES
              // sink() follows
              ;
